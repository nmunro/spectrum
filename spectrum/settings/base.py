...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "info.context_processors.api_keys",
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = "info:dashboard_organisations"
LOGOUT_REDIRECT_URL = "/"
...
ADMIN_EMAIL_LIST = config(
    "ADMIN_EMAIL_LIST", cast=lambda v: [s.strip() for s in v.split(",")]
